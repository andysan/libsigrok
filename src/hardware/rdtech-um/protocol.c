...
static const struct rdtech_um_channel rdtech_default_channels[] = {
	{ "V",  2, RDTECH_UM_UINT16, 0.01, 2, SR_MQ_VOLTAGE, SR_UNIT_VOLT },
	{ "I",  4, RDTECH_UM_UINT16, 0.001, 3, SR_MQ_CURRENT, SR_UNIT_AMPERE },
	{ "D+", 96, RDTECH_UM_UINT16, 0.01, 2, SR_MQ_VOLTAGE, SR_UNIT_VOLT },
	{ "D-", 98, RDTECH_UM_UINT16, 0.01, 2, SR_MQ_VOLTAGE, SR_UNIT_VOLT },
	{ "T", 10, RDTECH_UM_UINT16, 1.0, 0, SR_MQ_TEMPERATURE, SR_UNIT_CELSIUS },
	/* Threshold-based recording (mWh) */
	{ "E", 106, RDTECH_UM_UINT32, 0.001, 3, SR_MQ_ENERGY, SR_UNIT_WATT_HOUR },
	{ NULL, },
};

static const struct rdtech_um_channel rdtech_um25c_channels[] = {
	{ "V",  2, RDTECH_UM_UINT16, 0.001, 2, SR_MQ_VOLTAGE, SR_UNIT_VOLT },
	{ "I",  4, RDTECH_UM_UINT16, 0.0001, 3, SR_MQ_CURRENT, SR_UNIT_AMPERE },
	{ "D+", 96, RDTECH_UM_UINT16, 0.01, 2, SR_MQ_VOLTAGE, SR_UNIT_VOLT },
	{ "D-", 98, RDTECH_UM_UINT16, 0.01, 2, SR_MQ_VOLTAGE, SR_UNIT_VOLT },
	{ "T", 10, RDTECH_UM_UINT16, 1.0, 0, SR_MQ_TEMPERATURE, SR_UNIT_CELSIUS },
	/* Threshold-based recording (mWh) */
